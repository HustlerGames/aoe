...
bool TownPlanner::findBuildingPosition(int BuildingType, int sizeX, int sizeY, &posx, &posy)
{
	TownTemplateResource* res =  resources->pRoot->get(RESOURCE_CATEGORY_TEMPLATES)->get(TOWN_TEMPLATE1);
