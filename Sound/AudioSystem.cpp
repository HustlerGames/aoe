...
{
    sounds[SOUND_PICK1] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\pick1.wav"));
    sounds[SOUND_BACKGROUND1] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\background1.wav"));
    sounds[SOUND_HARVEST_TREE] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\harvest_tree1.wav"));
    sounds[SOUND_BUSH] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\bush.wav"));
    sounds[SOUND_BUILD] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\build.wav"));
    sounds[SOUND_BUILDING] = createSound(TEXT("d:\\projects\\TestGame\\source\\data\\sounds\\building.wav"));
}
